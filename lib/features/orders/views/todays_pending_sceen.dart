...
class TodaysPendingDeliveryScreen extends ConsumerWidget {
  const TodaysPendingDeliveryScreen({Key? key}) : super(key: key);
    ...
    return ScreenWrapper(
      child: Column(
        children: [
          ...
          Expanded(
              child: ref.watch(todaysPendingOrderListProvider).map(
                  ...
                  loaded: (_) => Padding(
                        ...
                        child: _.data.data!.orders!.isNotEmpty
                            ...
                            : const MessageTextWidget(msg: 'No Pending Order'),
                      ),
